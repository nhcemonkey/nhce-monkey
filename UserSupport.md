...
## 汇总信息： ##
|总计Bug报告数|119|已回复数|119|已解决数|8|
|:-------|:--|:---|:--|:---|:|
|总计建议数   |4  |已回复数|4  |已采纳数|4|
|总计其他信息数 |3  |已回复数|3  |    | |

![http://png-2.findicons.com/files//icons/575/pleasant/128/help_and_support.png](http://png-2.findicons.com/files//icons/575/pleasant/128/help_and_support.png)
...
|96|NHCE  |Bug|2012.5.22 15:57|登录失败|  |2012.05.23 08:33|当时网页返回的是“Datebase Error”，可能是服务器不稳定导致的，也可能是服务器在进行维护，应该不是程序本身的问题。|未知|  |
